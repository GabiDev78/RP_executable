...
def main():
    for i in range(0, 10):
        file1 = open("tests_temps15"+str(i)+".txt", "w")
    ...
    file1 = open("MoyRandDfs15.txt", "w")
    file1.write("moyenne des temps effectués par random sur le probleme 0 comportant 15 rectangles :"+str(i1/10.0)+"\n")
    file1.write("moyenne des temps effectués par random sur le probleme 1 comportant 15 rectangles :"+str(i2/10.0)+"\n")
    file1.write("moyenne des temps effectués par random sur le probleme 2 comportant 15 rectangles :"+str(i3/10.0)+"\n")
    file1.write("moyenne des temps effectués par random sur le probleme 3 comportant 15 rectangles :"+str(i4/10.0)+"\n")
    file1.write("moyenne des temps effectués par random sur le probleme 4 comportant 15 rectangles :"+str(i5/10.0)+"\n")
    file1.write("moyenne des temps effectués par random sur le probleme 5 comportant 15 rectangles :"+str(i6/10.0)+"\n")
    file1.write("moyenne des temps effectués par random sur le probleme 6 comportant 15 rectangles :"+str(i7/10.0)+"\n")
    file1.write("moyenne des temps effectués par random sur le probleme 7 comportant 15 rectangles :"+str(i8/10.0)+"\n")
    file1.write("moyenne des temps effectués par random sur le probleme 8 comportant 15 rectangles :"+str(i9/10.0)+"\n")
    file1.write("moyenne des temps effectués par random sur le probleme 9 comportant 15 rectangles :"+str(i10/10.0)+"\n")
    file1.write("moyenne des temps effectués par dfs sur le probleme 0 comportant 15 rectangles :"+str(j1/10.0)+"\n")
    file1.write("moyenne des temps effectués par dfs sur le probleme 1 comportant 15 rectangles :"+str(j2/10.0)+"\n")
    file1.write("moyenne des temps effectués par dfs sur le probleme 2 comportant 15 rectangles :"+str(j3/10.0)+"\n")
    file1.write("moyenne des temps effectués par dfs sur le probleme 3 comportant 15 rectangles :"+str(j4/10.0)+"\n")
    file1.write("moyenne des temps effectués par dfs sur le probleme 4 comportant 15 rectangles :"+str(j5/10.0)+"\n")
    file1.write("moyenne des temps effectués par dfs sur le probleme 5 comportant 15 rectangles :"+str(j6/10.0)+"\n")
    file1.write("moyenne des temps effectués par dfs sur le probleme 6 comportant 15 rectangles :"+str(j7/10.0)+"\n")
    file1.write("moyenne des temps effectués par dfs sur le probleme 7 comportant 15 rectangles :"+str(j8/10.0)+"\n")
    file1.write("moyenne des temps effectués par dfs sur le probleme 8 comportant 15 rectangles :"+str(j9/10.0)+"\n")
    file1.write("moyenne des temps effectués par dfs sur le probleme 9 comportant 15 rectangles :"+str(j10/10.0)+"\n")  
    file1.close()          
